# NOTE: this is copied from CMSSW/Configuration/DataProcessing
# TODO: think if it is a good idea to keep this file in the repository
...
def getScenario(scenarioName):
    ...
    try:
        module = __import__(moduleName, globals(), locals(), [scenarioName])  # , -1)
